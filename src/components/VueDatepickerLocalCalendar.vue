...
.calendar {
 ...
 .calendar+.calendar{
     border-left: solid 0.02rem #eaeaea;
     margin-left: 0.1rem;
     padding-left: 0.1rem;
}
 .calendar-head {
 ...
 .calendar-head .calendar-year-select, .calendar-head .calendar-month-select {
     font-size: 0.24rem;
     padding: 0 0.04rem;
     position: relative;
}
 ...
 .calendar-week:before, .calendar-date:before {
     content: "";
     display: inline-block;
     height: 100%;
 ...
 .calendar-date:hover, .calendar-date-on {
     background: #eaf8fe;
}
 ...
 .calendar-hour a:hover, .calendar-hour a.on {
     color: #1284e7;
}
 .calendar-years, .calendar-months, .calendar-hours, .calendar-minutes, .calendar-seconds {
     width: 100%;
     height: 100%;
     position: absolute;
     background: #fff;
